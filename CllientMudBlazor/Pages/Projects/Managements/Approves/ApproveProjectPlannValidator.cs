...
{
    public class ApproveProjectPlannValidator : AbstractValidator<ApproveProjectPlann>
    {
        private IHttpServices Service;

        public ApproveProjectPlannValidator(IHttpServices service)
        {
            Service = service;
        ...
        async Task<bool> ReviewIfNameExist(ApproveProjectPlann request, string name, CancellationToken cancellationToken)
        {
        ...
        async Task<bool> ReviewIfProjectNumberExist(ApproveProjectPlann request, string name, CancellationToken cancellationToken)
        {
